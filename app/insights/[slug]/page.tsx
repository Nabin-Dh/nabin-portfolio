      ...
      <Container className="py-16 sm:py-24">
        <div className="grid gap-12 lg:grid-cols-12">
          <article className="max-w-none lg:col-span-8 lg:pr-6">
            ...
            <article className="prose prose-invert mt-8 max-w-none prose-headings:tracking-tight prose-headings:text-text-primary prose-p:text-text-secondary prose-li:text-text-secondary prose-a:no-underline prose-strong:text-text-primary prose-blockquote:border-accent prose-blockquote:text-text-secondary prose-code:font-mono">
              <Post />
            </article>
          ...
          <aside className="lg:col-span-4">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="rounded border border-white/[0.06] bg-background-card p-5">
                <p className="font-mono text-xs uppercase tracking-widest text-text-secondary">
                  About the author
                </p>
                <p className="mt-3 text-sm leading-6 text-text-secondary">
                  {SITE.name} — {SITE.role.split("|")[0].trim()}.
                </p>
                <Link
                  href="/about"
                  className="mt-3 inline-block font-mono text-sm text-accent transition-colors hover:text-text-primary"
                >
                  read more...
                </Link>
              </div>
