...
export function InsightCardBody({ insight }: { insight: Insight }) {
  return (
    <Card className="flex h-full flex-col p-6 transition-colors hover:border-white/[0.12] sm:p-7">
      ...
      <Link
        ...
        className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-accent transition-colors hover:text-text-primary"
      >
        Read article
